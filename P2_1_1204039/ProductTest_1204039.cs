...
{
    class ProductTest_1204039
    {
        static void Main(String[] args)
        {
            /*
            Product_1204039 myProduct = new Product_1204039();

            myProduct.MyType = "DVD";

            Console.WriteLine(myProduct.MyType);*/

            /*Book_1204039 myBook = new Book_1204039("Book", "C# Object Oriented Solution", "300");

            Console.WriteLine("\"the book {0} has {1} pages\"", myBook.MyTitle, myBook.PageCount);*/

            Book_1204039 product1 = new Book_1204039("Book", "C# Object Oriented Solution", "300");
            DVD_1204039 product2 = new DVD_1204039("Eternal Sunshine of The Spotless Mind", "145");
